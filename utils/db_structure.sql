...
CREATE INDEX IF NOT EXISTS idx_leaderboard_run_season_dungeon_keylevel ON leaderboard_run(season_id, dungeon_id, keystone_level DESC, score ASC);
CREATE INDEX IF NOT EXISTS idx_leaderboard_run_season_period_dungeon_keylevel ON leaderboard_run (season_id, period_id, dungeon_id, keystone_level DESC, score DESC);
